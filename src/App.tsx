...
const Content: FC = () => {
    ...
    async function createCounter(){
        ...
        // create the program interface by combining the idl, program ID and provider
        // stringify the idl and the parse it into JSON object
        const a = JSON.stringify(idl);
        const b = JSON.parse(a);
        // create the program
        const program = new Program(b,idl.metadata.address, provider);
        try{
            // interact with the program via the rpc
    ...
    async function update(){
        ...
        try{
            // interact with the program via the rpc
            await program.rpc.update(new BN(200), {
                accounts: {
                    myAccount: baseAccount.publicKey
                    },
            })
